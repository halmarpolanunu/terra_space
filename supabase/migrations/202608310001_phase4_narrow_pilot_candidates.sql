-- Temporary owner-approved input for the five-candidate Phase 4 narrow-extraction pilot.
-- This view stores no data and changes no Phase 1-4 row.

create view public.terra_space_phase4_narrow_pilot_candidates as
select
...
comment on view public.terra_space_phase4_narrow_pilot_candidates is
  'Temporary owner-approved five-candidate input for validating the Phase 4 narrow extraction workflow.';
