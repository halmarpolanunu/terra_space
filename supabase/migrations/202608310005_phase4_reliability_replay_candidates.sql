-- Temporary owner-approved input for a controlled full Phase 4 reliability replay.
-- This view stores no data and changes no Phase 1-4 row.

create view public.terra_space_phase4_reliability_replay_candidates as
select
...
comment on view public.terra_space_phase4_reliability_replay_candidates is
  'Temporary read-only input for a controlled full Phase 4 reliability replay.';
